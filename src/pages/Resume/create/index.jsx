...
import { Button, Card, Col, Upload , Form, Input, Modal, Row, Select, Space, DatePicker } from 'antd';
...
const Resume = ({ submitting, dispatch }) => {
  ...
  const onFinish = (values) => {
    ...
    // data.skill = valueSplit(values.skill)
    // data.summary = valueSplit(values.summary)
    // data.experience.forEach(item => {
    //   item.project.forEach(itm => {
    //     itm.project_analysis = valueSplit(itm.project_analysis)
    //     itm.project_complete = valueSplit(itm.project_complete)
    //     itm.project_summary = valueSplit(itm.project_summary)
    //     itm.project_img = valueSplit(itm.project_img)
    //   })
    // })
    console.log(values)
